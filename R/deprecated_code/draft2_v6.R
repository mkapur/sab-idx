...
Surveys_to_include <- c("Triennial", "WCGBTS", "BCs", "BCt","AK_DOM_LL", "GOA", "EBS")[c(1,2,3,6)] #This will only work for years after 2003


# Date
Date <- Sys.Date()
BaseQ <- c("GOA_late","AK_DOM_late", "WCGBTS")[1]
