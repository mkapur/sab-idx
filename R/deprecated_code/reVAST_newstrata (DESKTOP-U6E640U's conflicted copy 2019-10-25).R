...
## Re
sourceFile <- "C:/Users/mkapur/Dropbox/UW/sab-idx/runs/2019-10-21_nx=100_Species=SAB_Triennial_WCGBTS_BC_GOA_EBS"
...
# load("C:/Users/mkapur/Dropbox/UW/sab-idx/runs/2019-10-21_nx=100_Species=SAB_Triennial_WCGBTS_BC_GOA_EBS/Data_Geostat.Rdata")
...
mle_params <- Obj$env$parList() ## need this from previous model run. 
## OBJ derives from TmbList which is a make_model object.
## this should run fastly
...
Obj2 <- new_obj[["Obj"]]
Obj2$par['lambda2_k'] ## should be a number (not zero)
Obj2$par['lambda1_k'] 
# Obj$par['gamma1_k'] 
...
# Save stuff
Save <- list("Opt"=Opt2, "Report"=Report, "ParHat"=new_obj$Obj$env$parList(Opt2$par))
