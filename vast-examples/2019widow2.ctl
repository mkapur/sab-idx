...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
             1            20       14.0006            10            99             0          2          0          0          0          0          0          0          0 # SR_LN(R0)
...
# DIRICHLET PARAMETERS (added by Stephanie 7-23, Sensitivity 8)
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type    PHASE  #  parm_name
			-5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 1		
			-5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 2
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 3
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 4
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 5
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 6
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 7
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 8
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 9
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 10		
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 11
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 12
			# -5			 20				-.2			0				50		0				2	 0          0          0          0          0          0          0	# ln (effN_mult) 13
...
#like_comp fleet  phase  value  sizefreq_method
 # 4 1 1 0.5 1 # BottomTrawl_Length_Comp
 # 4 2 1 0.5 1 # MidwaterTrawl_Length_Comp
 # 4 3 1 0.5 1 # Hake_Length_Comp
 # 4 4 1 0.5 1 # Net_Length_Comp
 # 4 5 1 0.5 1 # HnL_Length_Comp
 # 4 7 1 0.5 1 # Triennial_Length_Comp
 # 4 8 1 1 1 # NWFSC_Length_Comp
 # 5 1 1 0.5 1 # BottomTrawl_Marginal_Age_Comp
 # 5 2 1 0.5 1 # MidwaterTrawl_Marginal_Age_Comp
 # 5 3 1 0.5 1 # Hake_Marginal_Age_Comp
 # 5 4 1 0.5 1 # Net_Marginal_Age_Comp
 # 5 5 1 0.5 1 # HnL_Marginal_Age_Comp
 # 5 8 1 1 1 # NWFSC_CAAL
